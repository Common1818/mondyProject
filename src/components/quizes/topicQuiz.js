...
const _topicQuiz = (props) => {
    ...
    const choosenOption =(optionId)=>{
        ...
        if(quizQuestionAnswer[currentPage-1].correctAnswer === quizQuestionAnswer[currentPage-1][option] ){
            setScore(score + 1)
        }
    }
                        ...
                        <div className="m-5" key={props.selectedQuiz.id + currentPage}>
                            ...
                            <div className="mt-5">
                                ...
                                <div className="text-center text-danger mt-4">
                                    <i className="fas fa-trash-alt" onClick={()=>deleteQuestion(quizDispatch, currentPage, props.selectedQuiz.id)}></i>
                                </div>
                            </div>
                        </div>
                    ):(
